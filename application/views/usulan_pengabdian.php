	...
	<div class="panel-body">
            ...
            <div class="panel-body">
        		<form id="form_usulan_proposal" method="POST">
                    ...
                    <div class="form-group">
                       ...
                       <div class="row">
                            	<div class="col-md-10">
        	     				<input type="text" name="tahun_diajukan" id="tahun_diajukan" class="form-control" <?php if(empty($list->tahun_diajukan) || $list->tahun_diajukan == "0000-00-00"){?> value="<?=date("d-m-Y")?>" <?php }else{?> value="<?=$list->tahun_diajukan?>" <?php }?>readonly>
             					</div>
             					<div class="col-md-2">
        ...
        <div class="panel panel-primary setup-content" id="step-2">
            ...
            <div class="panel-body">
                <div class="form-group">
                    <form id="form_mitra">
                    <label class="control-label">Mitra Program</label> 
                        ...
                        <label class="control-label">jarak Lokasi (dalam km)</label> 
                        <input type="number" name="jarak_lokasi" id="jarak_lokasi" class="form-control">                   
                    <div id="notif"></div>
                    <br>
                    <div style="float:right;">
                    <button class="btn btn-primary mitra"><i class="fa fa-plus-square" aria-hidden="true"></i></button> 
                    </div>
                    <table class="table table-striped table-responsive">
                        <thead>
                            <tr>
                        ...
                        <?php foreach ($list_mitra as $lm) {
                         ?>
                        <tbody>
                            <td><?=$lm->nama_mitra?><input type="text" style="display: none" name="id_hapus" id="id_hapus3" value="<?=$lm->id_mitra?>"></td>
                            <td><?=$lm->propinsi?></td>
                            <td><?=$lm->kabupaten?></td>
                            <td><?=$lm->jarak_lokasi?> km</td>
                            <td><a href="#" class="hapus_mitra" id="<?=$lm->id_mitra?>" data-togle="modal" style="color:#DAA520; text-decoration:none;"><i class="fa fa-trash fa-lg" aria-hidden="true"></i></a> </td>
                        </tbody>
                        <?php } ?>
                    </table>
                    </form>
