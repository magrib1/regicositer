...
<div class="container" style="background:#fff;margin-top:0px; padding-top:30px; padding-bottom:15px; border-bottom:solid thin #e8e8e8; box-shadow:         0px -6px 22px 0px rgba(0, 0, 0, 0.2); border-radius: 3px;">
      ...
      <div class="row ">
        ...
        <div class="col-md-6">
            ...
            <!-- <form role="search" id="searchform" class="searchform " action="<?=base_url()?>depan/search"  method="POST">
                <input type="text" class="text-cari " name="cari" placeholder="Search by title/author/keyword" pattern="[a-zA-Z0-9-_\. ]{0,20}"/>
                <button type="submit" class=" button-cari " id="searchsubmit"><i class="fa fa-search" aria-hidden="true"> Cari</i></button>
            </form> -->
