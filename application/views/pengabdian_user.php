<div class="panel panel-default">
    ...
    <?php 
    $cek_ketua = $this->Model->ambil_banyak_kondisi('tb_usulan_proposal', array('ketua_peneliti' => $this->session->userdata('id'), 'jenis' => 'pengabdian','delete' => '0', 'status' => 'diterima', 'didanai' => 'didanai') )->num_rows();

    $waktu_sekarang = time();
    $waktu_akhir = $this->Model->ambil('jenis','pengabdian','tb_timeline')->row();
    ...
    ?>
        ...
        <a href="<?=base_url()?>user/pengabdian/create_usulan" target="_blank" style="text-decoration:none;" class="btn btn-primary btn-xs"><i class="fa fa-plus-square" aria-hidden="true"></i> Tambah Data</a>
        </div>
        <?php }?>
	</div>
    ...
    <?php }?>
        ...
        <?php if($l->status == 'diusulkan') {?>
          <?php if($waktu_sekarang  < $waktu_akhir){?>
  				<a href="<?=base_url()?>user/pengabdian/usulan/<?=$l->id_proposal?>" class="ubah_usulan btn btn-warning btn-xs" id="<?=$l->id_proposal?>" style="text-decoration:none;"><i class="fa fa-pencil-square fa-lg" aria-hidden="true"></i> Ubah</a> | <a href="#" class="hapus_usulan btn btn-danger btn-xs" id="<?=$l->id_proposal?>" data-togle="modal" style="text-decoration:none;"><i class="fa fa-trash fa-lg" aria-hidden="true"></i> Hapus</a> <br> 
          <?php }?>
          <a href="<?=base_url()?>/user/pengabdian/cetak_pengesahan/<?=$l->id_proposal?>" target="_blank" class="btn btn-success btn-xs" data-togle="modal" style="text-decoration:none;"><i class="fa fa-print fa-lg" aria-hidden="true"></i> Cetak Hal.Pengesahan</a> <br>
        ...
        <?php }elseif($l->status == 'diterima'){?>
            ...
            <a href="#lihat_proposal2" id="<?=$l->id_proposal?>" class="btn btn-info btn-xs lihat_proposal2" data-togle="modal" style="text-decoration:none;"><i class="fa fa-file-pdf-o fa-lg" aria-hidden="true"></i> Lihat Proposal</a> 
            <br>
            <a href="<?=base_url()?>/user/pengabdian/cek_nilai/<?=$l->id_proposal?>" id="" class="btn btn-default btn-xs" data-togle="modal" style="text-decoration:none;"><i class="fa fa-columns fa-lg" aria-hidden="true"></i> Lihat Nilai</a> <br>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="panel-body">
                <form id="form_upload_proposal" method="POST" action="<?=base_url()?>user/pengabdian/upload_proposal">
                 <br>
        ...
        <div class="modal-body">
          <div class="panel-body">
              <div id="result"></div>
               ...
               <form id="form_delete_proposal" method="POST" action="<?=base_url()?>user/pengabdian/hapus_file_proposal">
