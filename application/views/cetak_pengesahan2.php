...
<html>
  ...
  <body>
    <font size="12" face="Times New Roman">
        <br>
    <center>
        <h4> HALAMAN PENGESAHAN <br> PENELITIAN HIBAH MANDIRI </h4> <br>

        <table>
            <tr>
                <td class="col-md-3">1. Judul Penelitian</td>
            ...
            <?php }?>
             ...
             <tr>
                <td class="col-md-3">4. Jangka waktu pelaksanaan</td>
                <td class="col-md-9">: <?=@$list->lama_penelitian?> tahun</td>
            </tr>
            <tr>
                <td class="col-md-3">5. Biaya PkM</td>
                <td class="col-md-9"></td>
            </tr>
            <tr>
