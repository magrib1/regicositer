...
$(document).on('click', '.btn_approve', function(e){
    var id = $('#id_proposal').val();
     e.preventDefault();
        ...
        $.ajax({
            url: '<?=base_url()?>admin/penelitian/ubah_approve',
            type: 'POST',
            data: data,
            contentType:false,
            processData:false,
...
$(document).on('click', '.btn_reviewer', function(e){
     e.preventDefault();
        ...
        $.ajax({
            url: '<?=base_url()?>admin/penelitian/tambah_reviewer',
            type: 'POST',
            data: data,
            contentType:false,
            processData:false,
...
$(document).on('click', '.hapus_reviewer', function(msg){
    ...
    $(document).on('click', '.btn_hapus_kategori', function(e){
        var id = $('#id_hapus').val();
        $.ajax({
            url: '<?=base_url()?>admin/penelitian/hapus_reviewer',
            type: 'POST',
            data: 'id='+id,
            success: function(msg){
                $('#notif').html(msg);
    ...
    $(document).on('click', '.btn_hapus_usulan', function(e){
        var id = $('#id_hapus').val();
        $.ajax({
            url: '<?=base_url()?>admin/penelitian/hapus_usulan',
            type: 'POST',
            data: 'id='+id,
            success: function(msg){
                $('#notif').html(msg);
    ...
    var id = $('#id_proposal2').val();
     e.preventDefault();
        ...
        $.ajax({
            url: '<?=base_url()?>admin/penelitian/ubah_dana',
            type: 'POST',
            data: data,
            contentType:false,
            processData:false,
