<script type="text/javascript">
	$(document).ready(function(){
        ...
        $(document).on('keyup', "#nama_pegawai", function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?=base_url()?>user/penelitian/auto_pegawai",
                data: {
        ...
        //auto complete
            $(document).on('keyup', "#afiliasi_mhs", function (e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?=base_url()?>user/penelitian/auto_mhs",
                    data: {
    ...
    $(document).on('click', '.usulan', function(e){
        ...
        $.ajax({
            url: '<?=base_url()?>user/penelitian/ubah_usulan',
            type: 'POST',
            data: data,
            contentType:false,
            processData:false,
    ...
    $(document).on('click', '.afiliasi_dosen', function(e){
        ...
        $.ajax({
            url: '<?=base_url()?>user/penelitian/simpan_afiliasi_dosen',
            type: 'POST',
            data: data,
            contentType:false,
            processData:false,
     ...
     $(document).on('click', '.hapus_afiliasi_dosen', function(e){
        var id = $('#id_hapus').val();
        $.ajax({
            url: '<?=base_url()?>user/penelitian/hapus_afiliasi_dosen',
            type: 'POST',
            data: 'id='+id,
            success: function(msg){
                $('#notif').html(msg);
    ...
    $(document).on('click', '.afiliasi_mahasiswa', function(e){
        ...
        $.ajax({
            url: '<?=base_url()?>user/penelitian/simpan_afiliasi_mhs',
            type: 'POST',
            data: data,
            contentType:false,
            processData:false,
     ...
     $(document).on('click', '.hapus_afiliasi_mahasiswa', function(e){
        ...
        $.ajax({
            url: '<?=base_url()?>user/penelitian/hapus_afiliasi_mhs',
            type: 'POST',
            data: 'id='+id,
            success: function(msg){
                $('#notif').html(msg);
      ...
      $(document).on('click', '.mitra', function(e){
        ...
        $.ajax({
            url: '<?=base_url()?>user/penelitian/simpan_mitra',
            type: 'POST',
            data: data,
            contentType:false,
            processData:false,
     ...
     $(document).on('click', '.hapus_mitra', function(e){
        ...
        $.ajax({
            url: '<?=base_url()?>user/penelitian/hapus_mitra',
            type: 'POST',
            data: 'id='+id,
            success: function(msg){
                $('#notif').html(msg);
    ...
    $(document).on('click', '.finish', function(e){
        window.location.href="<?=base_url()?>user/penelitian";
    });
    ...
    $(document).on('click', '.lihat_proposal', function(e){
        ...
        $.ajax({
            url: '<?=base_url()?>user/penelitian/ambil_file',
            type: 'POST',
            data: 'id='+id,
            success: function(msg){
                $('#result').html(msg);
    ...
    $(document).on('click', '.komentar', function(e){
        ...
        $('#komentar').modal();
        $.ajax({
            url: '<?=base_url()?>user/penelitian/ambil_komentar',
            type: 'POST',
            data: 'id='+id,
            success: function(msg){
                $('#result3').html(msg);
    ...
    $(document).on('click', '.btn_hapus_usulan', function(e){
        var id = $('#id_hapus').val();
        $.ajax({
            url: '<?=base_url()?>user/penelitian/hapus_usulan',
            type: 'POST',
            data: 'id='+id,
            success: function(msg){
                $('#notif').html(msg);
    ...
    $(document).on('click', '.btn_upload_proposal', function(e){
        ...
        $.ajax({
            url: '<?=base_url()?>user/penelitian/upload_proposal',
            type: 'POST',
            data: data,
            contentType:false,
            processData:false,
    ...
    $(document).on('click', '.btn_hapus_proposal', function(e){
        ...
        $.ajax({
            url: '<?=base_url()?>user/penelitian/hapus_file_proposal',
            type: 'POST',
            data: data,
            contentType:false,
            processData:false,
